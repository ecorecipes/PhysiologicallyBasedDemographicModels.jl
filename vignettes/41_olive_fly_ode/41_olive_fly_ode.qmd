...
**Note:** The egg, larval, and adult mortality corrections above were cross-checked against the Rossini et al. GitHub reference implementation (`lucaros1190/ODE-bactrocera`, `Parameters.py`).
...
is available at <https://github.com/lucaros1190/ODE-bactrocera>; the mortality
parameter corrections in this vignette were cross-checked against its
`Parameters.py` reference implementation.
