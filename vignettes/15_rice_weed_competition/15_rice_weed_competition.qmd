---
title: "Rice–Weed Competition"
subtitle: "Resource Competition for Nitrogen and Light"
author: "Simon Frost"
bibliography: ../references.bib
---

Primary reference: [@Graf1990RiceWeeds].
...
Now simulate rice in competition with all six weed groups using the coupled
population API. A `StressRule` computes light and nitrogen stress before
stepping, and a `CustomRule` updates the shared soil nitrogen pool.
