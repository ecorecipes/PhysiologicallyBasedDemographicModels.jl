---
title: "Bt Cotton Resistance Evolution"
author: "Simon Frost"
bibliography: ../references.bib
---

Primary reference: [@Gutierrez2006BtCottonChina].
...
couples PBDM population dynamics with **Hardy-Weinberg single-gene genetics**
to model the evolution of Bt resistance in pink bollworm
...
and fecundity responses to Bt toxin. Spatial refuges (non-Bt cotton)
and temporal refuges (variable toxin concentration) slow resistance
evolution by maintaining susceptible alleles in the population.

**Reference:** Gutierrez, A.P., Adamczyk Jr., J.J., Ponsard, S., and
Ellis, C.K. (2006). *Physiologically based demographics of Bt cotton–pest
interactions II. Temporal refuges, natural enemy interactions.*
...
vital rates. The three populations share the same environment (cotton field)
but differ in their response to Bt toxin.
...
Mandated refuges of non-Bt cotton preserve susceptible genotypes.
Gene flow from refuge dilutes resistance alleles each generation.
...
Bollgard II expresses both Cry1Ac and Cry2Ab. Resistance to each
toxin is tracked independently.
...
Not all pests respond equally to Bt. The model captures a spectrum
from highly susceptible (pink bollworm) to essentially immune (Lygus).
...
2. **Refuges are essential**: Even 5% non-Bt cotton dramatically slows
   resistance evolution by maintaining susceptible alleles through
   gene flow. Without refuges, resistance can fix in 4–6 years.
