...
Primary reference: [@GarayNarvaez2015Spodoptera].
...
Garay-Narváez et al. (2015) developed a discrete-time, stage-structured model
of the *S. exigua*–*H. didymator* system using distributed delays (the
...
developmental thresholds ($T_{min}$) estimated from laboratory rearing data
(Garay-Narváez et al. 2015, Table 1). Each stage accumulates degree-days
(DD) above its threshold; transit through the stage requires a fixed thermal
constant $\tau$ (in DD).
...
- Garay-Narváez L, Arim M, Flores JD, Ramos-Jiliberto R (2015). The
  more polluted the environment, the more important observational
  ecology becomes. *Environmental Modelling and Software* 67:27–35.
