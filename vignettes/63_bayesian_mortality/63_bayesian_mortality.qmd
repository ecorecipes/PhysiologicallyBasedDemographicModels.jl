...
Following [@Lanzarone2017, Eqs. 13–15], the paper's likelihood is a
**Gamma observation model** for each stage at each observation time.
...
following [@Lanzarone2017, sec. 3.2] (the paper notes the priors
