...
files S1–S4 of Gutierrez et al. [-@Gutierrez2021FruitFly]. The
stage-specific T_base and DD values below are corrected to match Table 2.
Where the paper reports data for egg-larval and pupal stages separately, we
...
cold-tolerant species: melon fly (7.95 °C) and oriental fruit fly
(8.87 °C) initiate development at cooler temperatures than mexfly
(10.3 °C).
...
the paper's full nonlinear development functions with linear DD accrual.*

## Key Insights

1. **Cold tolerance sets the poleward limit.** With the corrected Table 2
   values, melon fly (T_base ≈ 7.95 °C) and oriental fruit fly
   (8.87 °C) can accumulate degree-days at cooler temperatures than
   medfly and mexfly, materially changing the comparative cold-tolerance
