...
**Note:** The vital-rate functions below are *illustrative* parameterizations
chosen to demonstrate the RI framework. They are representative of each
species' thermal biology but are not taken directly from Ndjomatchoua et al.
(2024). For species-specific parameter fitting, consult the primary
entomological literature for each pest.
