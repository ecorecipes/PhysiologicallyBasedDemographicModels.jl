...
"""
    cumulative_degree_days(sol::PBDMSolution)

Return cumulative degree-day accumulation over the simulation.
"""
function cumulative_degree_days(sol::PBDMSolution)
    return cumsum(sol.degree_days)
end
